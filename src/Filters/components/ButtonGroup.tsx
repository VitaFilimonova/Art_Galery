    ...
    return (
        <div className={classes.buttons}>
            {setFilter && setFilterName &&
                <button
                    className={`${classes.button__clear} ${filterName == undefined ? classes.button__clear_hide : ''}`}
                    onClick={event => {
            ...
            <div className={classes.arrow}>
                <img src={darkMode ? arrowDark : arrowLight}
                     className={`${classes.arrow__img} ${isOpen ? classes.arrow__img_open : ''}`}
                     alt="Arrow"/>
            </div>
