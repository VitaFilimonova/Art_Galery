...
const Pagination: React.FC = () => {
    ...
    return (
        <div className={classes.container}>
            ...
            <PaginationArrow handlePageChange={handlePageChange} currentPageNumber={1} image={doubleArrLeft}
                             pageChange={1} isFirst={true} currPage={currentPage}/>
            <PaginationArrow handlePageChange={handlePageChange} currentPageNumber={1} image={arrLeft}
                             pageChange={currentPage - 1} currPage={currentPage}/>

            {visiblePages.map((page) => (
                <button
                    key={page}
                    className={`${classes.button} ${currentPage === page ? classes.button_active : ''} ${darkMode ? classes.button_dark : ''}`}
            ...
            <PaginationArrow handlePageChange={handlePageChange} currentPageNumber={totalPages} image={arrRight}
                             pageChange={currentPage + 1} currPage={currentPage}/>
            <PaginationArrow handlePageChange={handlePageChange} currentPageNumber={totalPages} image={doubleArrRight}
                             pageChange={totalPages} isLast={true} currPage={currentPage}/>
